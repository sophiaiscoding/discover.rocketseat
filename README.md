...
2. Cole o link do arquivo **index.html** desse repositório no campo indicado de input;
3. Pressione **Enter** para visualizar.
...
1. Clone esse repositório:
   ```bash
   git clone https://github.com/seu-usuario/discover.rocketseat.git
   ```
...
---
Feito com 💜 por [Sophia Latache](https://github.com/sophiaiscoding)
